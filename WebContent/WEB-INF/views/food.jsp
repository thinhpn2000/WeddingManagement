...
<body onload="startTime() && showDate() && showFoodUpdated()">
    ...
    <div id="wrapper">
        ...
        <div class="nav">
          ...
          <li>
              <a href="<%= request.getContextPath() %>/food" class="active">
                  <span class="menu-tab-icon">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="updateForm">
                                ...
                                <div class="content p-4">
                                    <!--Modal delete-->
                                    <div class="modal fade" id="deleteFoodModal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                                        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-footer">
                                            <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal" onclick="deleteFood()">Yes</button>
                                            <button type="button" class="btn btn-success btn-sm" data-dismiss="modal">Cancel</button>
                                            </div>
                                        </div>
                                        </div>
                                    ...
                                    <form class="formAdd" action="" method="">
                                        ...
                                        <div id="" class="container-fluid text-left mb-3">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm">
                                                    <lable>Price</lable>
                                                    <input type="text" class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="cost" required>
                                                </div>
                                            </div>
                                    ...
                                    <form class="formAdd" action="" method="">
                                        ...
                                        <div id="newFood" class="container-fluid text-left mb-3">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm">
                                                    <lable>Price</lable>
                                                    <input type="text" class="form-control" name="cost" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required>
                                                </div>
                                            </div>
                                            <div class="text-right">
                                                <button class="btn btn-secondary btn-sm" type="submit"
