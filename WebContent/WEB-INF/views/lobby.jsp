...
<body onload="startTime() && showDate() && showLobbyUpdated()">
    ...
    <div id="wrapper">
        ...
        <div class="nav">
          ...
          <li>
            <a href="<%= request.getContextPath() %>/lobby" class="active">
                <span class="menu-tab-icon">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="updateForm">
                                ...
                                <div class="content p-4">
                                    ...
                                    <!--Modal delete-->
                                    <div class="modal fade" id="deleteLobbyModal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                                        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                            Do you want to delete this lobby?
                                            </div>
                                            <div class="modal-footer">
                                            <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal" onclick="deleteLobby()">Yes</button>
                                            <button type="button" class="btn btn-success btn-sm" data-dismiss="modal">Cancel</button>
                                            </div>
                                        </div>
                                        </div>
                                        ...
                                        <div id="" class="container-fluid text-left">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-lg-5 col-md-4">
                                                    ...
                                                    <input type="text" name="maxQuantity" class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required>
                                                </div>

                                                <div class="col-lg col-md-4">
                                                    <lable>Minimum price per table</lable>
                                                    <input type="text" class="form-control" name="costMin" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required>
                                                </div>
                                                <div class="col-lg col-md-4">
                                                    <lable>Note</lable>
                                    ...
                                    <form class="formAdd" action="" method="">
                                        ...
                                        <div id="newLobby" class="container-fluid text-left">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-lg col-md-4">
                                                    <lable>Minimum price per table</lable>
                                                    <input type="text" name="costMin" class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required>
                                                </div>
                                                <div class="col-lg col-md-4">
                                                    <lable>Note</lable>
