    ...
    <div id="wrapper">
      ...
      <div class="admin-wrapper">
        <div class="nav">
          ...
          <li>
              <a href="<%= request.getContextPath() %>/employee" class="active">
                  <span class="menu-tab-icon">
        ...
        <div id="employee" class="employee">
            <div class="container-fluid mt-3">
              <div class="row">
                ...
                <div class="col-sm-10 ">
                    <!--Modal delete-->
                    <div class="modal fade" id="deleteEmployeeModal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                      <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                          ...
                          <div class="modal-footer">
                            <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal" onclick="deleteEmployee()">Yes</button>
                            <button type="button" class="btn btn-success btn-sm" data-dismiss="modal">Cancel</button>
                          </div>
                        </div>
                      </div>
                    ...
                    <!--Add Employee-->
                    <div class="title-employee d-flex align-items-center justify-content-center disable">
                        <h2>New Employee Infomation</h2>
                    </div>
                
                    <form class="formAdd container-fluid border mb-3" action="" method="">
                        <div id="newEmployee" class="text-left">
                            ...
                            <div class="col-lg col-md-4">
                                <lable>Salary</lable>
                                <input class="form-control" name="salary" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                            </div>
                            <div class="col-lg col-md-4">
                            ...
                            <button class="btn btn-secondary mb-3" type="submit" onclick="">Add</button>
                            <button class="btn btn-outline-secondary mb-3" type="button" onclick="closeForm(0)">Cancel</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <form class="formAdd container-fluid border mb-3" action="" method="">
                        <div class="text-left">
                            ...
                            <div class="text-right">
                            <button class="btn btn-secondary mb-3" type="submit" onclick="">OK</button>
                            <button class="btn btn-outline-secondary mb-3" type="button" onclick="closeForm(1)">Cancel</button>
                            </div>
                        </div>
                    </form>

                    <!--Filter-->
                    <div class="title-employee d-flex align-items-center justify-content-center">
                        <h2>Employee List</h2>
                    </div>
                    <div class="container-fluid py-2 filter">
                        <form class="row" action="" method="">
                          <div class="col-xl-5 col-sm">
                              ...
                              <select class="form-control pt-0 pb-0" id="role" name="role">
                          ...
                          <div class="col-xl-5 col-sm">
                              ...
                              <select class="form-control pt-0 pb-0" id="status" name="status">
                                  <option value="any">any</option>
                          ...
                          <div class="col-xl col-sm-3 d-flex justify-content-center align-items-center">
                              <button id="btnSearchEmployee" type="submit" class="btn btn-secondary"  onclick="">Search</button>
                          </div>
                        </form>
                    </div>
                    ...
                    <div class="text-right mt-2">
                        <button class="btn btn-secondary" type="button" onclick="showForm(0)">Add</button>
                    </div>
                </div> 
